...
<h5 class="card-header col-sm-12">{{$universidad->nombre}}</h5>
    ...
    <div class="input-group mb-3 col-sm-9 mt-3">
        <div class="input-group-prepend">
            ...
            <span class="input-group-text ml-1"><i class="fas fa-building"></i></span>
        </div>
        <!-- campus -->
    ...
    <div class="input-group mb-3 col-sm-5">
        ...
        <div class="input-group-prepend">
            ...
            <span class="input-group-text ml-1"><i class="fas fa-font"></i></span>
        </div>
    ...
    <div class="input-group col-sm-8">
        <!-- pais -->
        <div class="input-group-prepend">
            <label for="pais" class="mr-3 requerido ml-3"><small>País</small></label>
    ...
    <div class="mt-3 col-sm-7">
        <div class="input-group mt-1">
            <h6 class="requerido"><small>Tipo de universidad</small></h6>
            <label class="ml-5">
